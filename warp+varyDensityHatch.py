...
def Main():
    ...
    angX = rs.GetReal("enter angle of hatch in first direction (degrees)", 50)
    angY = rs.GetReal("enter angle of hatch in second direction (degrees)", 70)
    ...
    strength = rs.GetReal("enter desired range for warp",15)
